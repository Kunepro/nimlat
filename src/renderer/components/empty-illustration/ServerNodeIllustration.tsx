...
import styles from "./ServerNodeIllustration.module.css";

const ServerNodeIllustration: FC = () => {
	const idPrefix           = useId().replace(
		/:/g,
		"",
	);
	const maskOuterId        = `${ idPrefix }-mask-outer`;
	const maskInnerId        = `${ idPrefix }-mask-inner`;
	const gradient0Id        = `${ idPrefix }-gradient-0`;
	const gradient1Id        = `${ idPrefix }-gradient-1`;
	const gradient2Id        = `${ idPrefix }-gradient-2`;
	const gradient3Id        = `${ idPrefix }-gradient-3`;
	const gradient4Id        = `${ idPrefix }-gradient-4`;
	const gradient5Id        = `${ idPrefix }-gradient-5`;
	const gradient6Id        = `${ idPrefix }-gradient-6`;
	const gradient7Id        = `${ idPrefix }-gradient-7`;
	const gradient8Id        = `${ idPrefix }-gradient-8`;
	const gradient9Id        = `${ idPrefix }-gradient-9`;
	const gradient10Id       = `${ idPrefix }-gradient-10`;
	const gradient11Id       = `${ idPrefix }-gradient-11`;
	const gradient12Id       = `${ idPrefix }-gradient-12`;
	const gradient13Id       = `${ idPrefix }-gradient-13`;
	const panelMaskPrimaryId = `${ idPrefix }-panel-mask-primary`;
	const panelMaskSecondaryId = `${ idPrefix }-panel-mask-secondary`;
	...
	return (
		...
		>
			...
			<path
				...
				className={ `${ styles.bounceLine } ${ styles.lineV2 }` }
			/>
			<g className={ styles.bounceGroup }>
				<path
			...
			<g className={ styles.particles }>
				...
				<path
					...
					className={ `${ styles.particle } ${ styles.p6 }` }
				/>
				<path
					fill={ `url(#${ gradient9Id })` }
...
export default ServerNodeIllustration;
