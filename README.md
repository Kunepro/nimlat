...
the draft. Installer filenames include the target operating system. No temporary GitHub Actions artifacts are stored;
publishing the verified draft remains a manual action.
